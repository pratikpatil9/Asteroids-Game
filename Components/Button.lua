...
Button = function (func, text_color, button_color, width, height, text, text_align, font_size, button_x, button_y, text_x, text_y)
    local btn_text = {

    }
    local func = func or function () print("This button has no functions attached") end
    ...
    return {
        ...
        setButtonColor = function (self,red,green,blue)
            button_color = {r = red, g = green, b = blue}
        end,

        setTextColor = function (self,red,green,blue)
            text_color = {r = red, g = green, b = blue}
        end,

        getButtonPos = function (self)
